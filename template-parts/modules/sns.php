...
<div id="js-sns" class="snsShare">
	...
	<ul class="snsShare__list">
		...
		<li class="snsShare__item">
			<a href="//b.hatena.ne.jp/add?mode=confirm&amp;url=<?php echo urlencode( get_permalink() ); ?>&amp;title=<?php echo urlencode(get_the_title() ); ?>" class="btnShare btnShare--ha js-share-ha">
